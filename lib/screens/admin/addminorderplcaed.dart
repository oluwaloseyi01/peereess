...
class Addminorderplcaed extends StatefulWidget {
  const Addminorderplcaed({super.key});

  @override
  State<Addminorderplcaed> createState() => _AddminorderplcaedState();
}

class _AddminorderplcaedState extends State<Addminorderplcaed> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() {
      context.read<AdminProvider>().fetchAllNewPlacedOrders();
    });
  }

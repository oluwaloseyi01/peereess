...
class OnDeliveryOrdersPage extends StatefulWidget {
  const OnDeliveryOrdersPage({super.key});

  @override
  State<OnDeliveryOrdersPage> createState() => _OnDeliveryOrdersPageState();
}

class _OnDeliveryOrdersPageState extends State<OnDeliveryOrdersPage> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() {
      context.read<AdminProvider>().fetchAllOrdersOnDelivery();
    });
  }
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            ...
            const Text("On Delivery Orders", style: TextStyle(fontSize: 16)),
          ],
        ),
      ),
